...
def extract_delivery_statuses(payload: dict[str, Any]) -> list[dict[str, Any]]:
    """Extract message delivery events from a WhatsApp webhook payload.

    Supported webhook states include sent, delivered, read, and failed.
    This data describes message delivery only; it is not an online-status check.
    """
